...
if(name.length!=0&&phone.length==10&&password.length!=0)
{
	var xmlhttp = new XMLHttpRequest();
  	xmlhttp.onreadystatechange = function() {
    	if (this.readyState == 4 && this.status == 200) {
                ...
                else{alert('<i class="fa fa-info-circle"></i><h3>Phone Number Already used..!</h3>');}
            }
        };
    xmlhttp.open("GET", "signin.php?name="+name+"&phone="+phone+"&password="+password, true);
    xmlhttp.send();
}
